...
import com.honor.sqlbuilder.*;
import org.springframework.dao.DataAccessException;
import org.springframework.jdbc.core.JdbcTemplate;
import org.springframework.jdbc.core.ResultSetExtractor;
import org.springframework.jdbc.core.RowMapper;

import com.honor.sqlbuilder.DeleteCreator;
import com.honor.sqlbuilder.InsertCreator;
import com.honor.sqlbuilder.Predicate;
import com.honor.sqlbuilder.SelectCreator;
import com.honor.sqlbuilder.Supplier;
import com.honor.sqlbuilder.UpdateCreator;
...
//        }
    ...
    public T findById(Object id) throws RowNotFoundException, TooManyRowsException {
        return findWhere(Predicates.eq(idColumn.getColumnName(), id)).getSingleResult();
    }
    ...
    public T findByIdOrNull(Object id) throws TooManyRowsException {
        return findWhere(Predicates.eq(idColumn.getColumnName(), id)).getSingleResultOrNull();
    }
